...
import type { AgentContent, Message, UserContext } from '@/integrations/baml_client/types';

// Re-export for use in hooks
export type { SSEService } from '@/features/nova/server/sse-connection';
...
import type { partial_types } from '@/integrations/baml_client/partial_types';
